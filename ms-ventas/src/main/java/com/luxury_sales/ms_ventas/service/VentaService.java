...
@Slf4j
@Service
@RequiredArgsConstructor // Lombok genera automáticamente el constructor para los campos 'final'
public class VentaService {

    // Al declararlos como 'final', Lombok los inyecta automáticamente.
    // Los nombres de las variables coinciden exactamente con tus @Beans configurados.
